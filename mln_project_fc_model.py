...
clf1 = MLPClassifier(hidden_layer_sizes=[64,128,256,64],activation='relu')
model1 = clf1.fit(inputs_train1, outputs_train1[:,0])
print("Trained")
y1 = model1.predict(inputs_val1)

clf2 = MLPClassifier(hidden_layer_sizes=[64,128,256,64],activation='relu')
model2 = clf2.fit(inputs_train2, outputs_train2[:,1])
print("Trained")
y2 = model2.predict(inputs_val2)

clf3 = MLPClassifier(hidden_layer_sizes=[64,128,256,64],activation='relu')
model3 = clf3.fit(inputs_train3, outputs_train3[:,2])
print("Trained")
y3 = model3.predict(inputs_val3)

clf4 = MLPClassifier(hidden_layer_sizes=[64,128,256,64],activation='relu')
